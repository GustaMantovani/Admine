...
minecraft_server:
  ...
  image:
    type: "FABRIC"          # VANILLA | FABRIC | FORGE | NEOFORGE | PAPER | QUILT | PURPUR | …
    version: "1.20.1"       # Minecraft version, or "LATEST"
    fabric_loader_version: ""
    forge_version: ""
    java_version: ""        # e.g. "java21" — selects JDK image tag
    modpack_url: ""
    extra_env:
...
image:
  ...
  extra_env:
    ...
    MODRINTH_MODPACK: "fabric-api"    # slug, project ID, or .mrpack URL
