...
class MinecraftServiceFactory:
    __PROVIDER_FACTORIES: Dict[MinecraftServiceProviderType, Callable[[Logger, Config], Any]] = {
    ...
    @staticmethod
    def create(logging: Logger, provider_type: MinecraftServiceProviderType, config: Config) -> MinecraftServerService:
        ...
        if factory:
            ...
            logging.error(f"Unknown MinecraftServiceProviderType requested: {provider_type}")
