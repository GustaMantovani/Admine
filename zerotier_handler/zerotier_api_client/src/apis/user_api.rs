...
pub async fn add_api_token(configuration: &configuration::Configuration, user_id: &str, api_token: models::ApiToken) -> Result<models::ApiToken, Error<AddApiTokenError>> {
...
pub async fn update_user_by_id(configuration: &configuration::Configuration, user_id: &str, user: models::User) -> Result<models::User, Error<UpdateUserByIdError>> {
    let local_var_configuration = configuration;
