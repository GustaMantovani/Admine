...
pub async fn get_network_by_id(configuration: &configuration::Configuration, network_id: &str) -> Result<models::Network, Error<GetNetworkByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_network_list(configuration: &configuration::Configuration, ) -> Result<Vec<models::Network>, Error<GetNetworkListError>> {
    let local_var_configuration = configuration;
...
pub async fn new_network(configuration: &configuration::Configuration, body: serde_json::Value) -> Result<models::Network, Error<NewNetworkError>> {
    let local_var_configuration = configuration;
...
pub async fn update_network(configuration: &configuration::Configuration, network_id: &str, network: models::Network) -> Result<models::Network, Error<UpdateNetworkError>> {
    let local_var_configuration = configuration;
