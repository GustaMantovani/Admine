...
pub async fn accept_invitation(configuration: &configuration::Configuration, invite_id: &str) -> Result<models::OrganizationInvitation, Error<AcceptInvitationError>> {
...
pub async fn get_invitation_by_id(configuration: &configuration::Configuration, invite_id: &str) -> Result<models::OrganizationInvitation, Error<GetInvitationByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_organization_by_id(configuration: &configuration::Configuration, org_id: &str) -> Result<models::Organization, Error<GetOrganizationByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_organization_invitation_list(configuration: &configuration::Configuration, ) -> Result<Vec<models::OrganizationInvitation>, Error<GetOrganizationInvitationListError>> {
    let local_var_configuration = configuration;
...
pub async fn get_organization_members(configuration: &configuration::Configuration, org_id: &str) -> Result<models::OrganizationMember, Error<GetOrganizationMembersError>> {
    let local_var_configuration = configuration;
...
pub async fn invite_user_by_email(configuration: &configuration::Configuration, organization_invitation: models::OrganizationInvitation) -> Result<models::OrganizationInvitation, Error<InviteUserByEmailError>> {
    let local_var_configuration = configuration;
