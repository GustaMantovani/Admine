...
pub struct AuthMethods {
    ...
    pub google: Option<Option<String>>,
    /// Generic OIDC ID
    #[serde(rename = "oidc", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub oidc: Option<Option<String>>,
}
