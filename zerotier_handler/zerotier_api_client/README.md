# Rust API client for zerotier_api_client
...
Put the package under your project folder in a directory named `zerotier_api_client` and add the following to `Cargo.toml` under `[dependencies]`:

```
zerotier_api_client = { path = "./zerotier_api_client" }
```
...
## Documentation For Models
 ...
 - [NetworkSsoConfig](docs/NetworkSsoConfig.md)
 - [OrgSsoConfig](docs/OrgSsoConfig.md)
